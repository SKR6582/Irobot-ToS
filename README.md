...
4. **Privacy**
The bot does not collect personal information for other purposes. User conversations are only used for generating responses and are not stored or used for any other purpose. However, Discord's server logs and data are managed by Discord.
